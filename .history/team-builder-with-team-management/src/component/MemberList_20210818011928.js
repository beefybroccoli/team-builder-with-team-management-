    ...
    <div>
...

      {
        props.input_member_list &&
          Array.from(props.input_member_list).map((object) => {
            return (
              <>
                <p>
                  id, {object.input_text_firstName.input_text_firstName},
                  {element.input_text_lastName},{element.input_select_title},{" "}
                  {element.input_text_email}
                </p>
              </>
            );
          })
