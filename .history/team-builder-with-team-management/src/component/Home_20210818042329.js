...
export default function Home(props) {
  ...
  const cb_modify_existing_member = (object) => {
    //create a temporary array
    const temp_array = [...member_list];
    ...
    if (object) {
      ...
      console.log(`before temp_array[${object.in}] = `, temp_array[object]);
      temp_array[object] = member;
      console.log(`after temp_array[${object}] = `, temp_array[object]);
    }
